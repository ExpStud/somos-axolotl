...
const TeamHeader: FC = () => {
  ...
  //{t("")}
  return (
    <div className="relative self-center flex items-center justify-between sm:justify-center px-12 aspect-[3/1] md:aspect-[5.25/1] w-full lg:h-[274px] mt-24 md:mt-20 lg:mt-32 -z-10 sm:gap-32 lg:gap-[400px] xl:gap-[605px]">
