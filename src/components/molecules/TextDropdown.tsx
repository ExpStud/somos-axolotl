...
const TextDropdown: FC<Props> = (props: Props) => {
  ...
  return (
    <div className={`flex flex-col gap-3 ${className}`}>
      ...
      <div
        className="hover-less-opacity flex w-full sm:w-[150px] h-[40px] row-centered gap-2 border border-somos-brown-dark text-somos-brown-dark rounded-[34px] cursor-pointer"
