  ...
  const team: Team[] = [
    {
      ...
      text: t("team_scum"),
      src: `${process.env.CLOUDFLARE_STORAGE}/images/about/scum-2.png`,
      mobile: `${process.env.CLOUDFLARE_STORAGE}/images/about/scum-sm-2.png`,
      direction: "right",
      backgroundColor: "",
      accentColor: "#41240F",
    },
    {
      ...
      text: t("team_gio"),
      src: `${process.env.CLOUDFLARE_STORAGE}/images/about/gio-1.png`,
      mobile: `${process.env.CLOUDFLARE_STORAGE}/images/about/gio-sm-1.png`,
      direction: "left",
      backgroundColor: "",
      accentColor: "#FE6375",
    },
    {
      ...
      name: "Casson Trenor",
      text: t("team_cass"),
      src: `${process.env.CLOUDFLARE_STORAGE}/images/about/cass.png`,
